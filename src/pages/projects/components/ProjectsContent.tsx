        ...
        <div className="projects-content-container">
            <div className="projects-content-wrapper px-[5%] w-auto h-auto">
                <div className="margin-content-container mx-auto w-full max-w-[80rem] h-auto">
                    <div className="padding-content-container py-14 w-auto h-auto md:py-18">
                        ...
                        md:grid-cols-2 md:gap-x-12 md:gap-y-16">
                            <div className="image-wrapper w-auto h-auto border-4 shadow">
                                <img className="w-auto max-w-full h-auto" src={personalBlogCover} alt="Project 2 cover"></img>
                            </div>
                            <div className="content-wrapper w-auto h-auto">
                                ...
                                <a className="group transition-all duration-300 ease-in-out break-all 2xl:text-lg" href="https://github.com/Patri22k/Roadmap-backend/tree/master/personal-blog" target="_blank">
                                    <span className="hover:transitions-color text-blue-800 hover:text-sky-500 bg-left-bottom bg-gradient-to-r from-sky-500 to-sky-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">
                                        <LinkOutlined /> https://github.com/Patri22k/Roadmap-backend/tree/master/personal-blog
                                    </span>
                                </a>
                            </div>
                        </div>
